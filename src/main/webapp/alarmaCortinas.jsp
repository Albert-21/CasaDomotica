<%-- 
    Document   : alarmaCortinas
    Created on : 26 abr 2021, 18:30:03
    Author     : alberto
--%>
...
<%
    ...
    if (act == null) {
        lista = cliente.mostrarAlarmasCortinas(session.getAttribute("user").toString());
            ...
            <form style="margin:5%; background-color:#F2F2F2; padding: 5%; ">
                ...
                <div class="form-group">
                    <div class="row">
                        <!-- primera columna -->
                        <div class="col-md-4">
                            <input  class="form-control"type="text" name="idCortina" placeholder="Id Cortina">
                        </div>
                        <!-- segunda columna -->
                        <div class="col-md-4">
